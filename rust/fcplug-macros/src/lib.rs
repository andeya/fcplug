...
/// Register protobuf method's ABI for callback.
...
pub fn ffi_pb_method(_args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let new_item = quote! {
        #[inline]
        #[no_mangle]
        pub extern "C" fn #new_ident(req: ::fcplug_rclib::Buffer) -> ::fcplug_rclib::FFIResult {
            #raw_item
            ::fcplug_rclib::protobuf::callback(::std::stringify!(#new_ident), #raw_ident, &req)
        }
    };
...
/// Register flatbuf method's ABI for callback.
...
pub fn ffi_fb_method(_args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let new_item = quote! {
        ...
        pub extern "C" fn #new_ident(req: ::fcplug_rclib::Buffer) -> ::fcplug_rclib::FFIResult {
            #raw_item
            let (_resp_, mut _w_) = #raw_ident(::fcplug_rclib::flatbuf::FbRequest::try_from_buffer(&req)?);
