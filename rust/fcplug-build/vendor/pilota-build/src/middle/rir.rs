...
impl Field {
    ...
    pub fn is_in_stack(&self) -> bool {
        self.ty.in_stack.read().unwrap().unwrap_or(false)
    }
}
...
pub struct Message {
    ...
    pub(crate) all_in_stack: Arc<RwLock<Option<bool>>>,
}
...
impl Message {
    pub fn is_all_in_stack(&self) -> bool {
        self.all_in_stack.read().unwrap().unwrap_or(false)
    }
}
